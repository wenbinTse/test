...
class ReviewElement extends React.Component<Props, State> {
  ...
  public render() {
    ...
    const profileName = review.owner.name ? review.owner.name.substr(0, 1) : '';
      ...
      <div className={Styles.container} style={style}>
        ...
        <div style={{width: '100%'}}>
          ...
          <div>
            ...
            {this.props.type === 'review' && this.state.showRelies && <Reviews type="reply" reviewId={this.props.review._id}/>}
        </div>
      </div>
    );
  }
